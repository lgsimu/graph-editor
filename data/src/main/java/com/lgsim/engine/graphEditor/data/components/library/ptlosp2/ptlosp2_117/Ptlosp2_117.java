package com.lgsim.engine.graphEditor.data.components.library.ptlosp2.ptlosp2_117;
 ...
 * 117类型元件
 */
public class Ptlosp2_117 extends Ptlosp2Base {

    private final String ID = "117";
