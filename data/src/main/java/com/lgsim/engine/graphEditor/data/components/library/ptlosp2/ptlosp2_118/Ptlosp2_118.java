package com.lgsim.engine.graphEditor.data.components.library.ptlosp2.ptlosp2_118;
 ...
 * 118类型元件
 */
public class Ptlosp2_118 extends Ptlosp2Base {

    private final String ID = "118";
