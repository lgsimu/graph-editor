package com.lgsim.engine.graphEditor.data.components.library.hole3.hole3_base;
 ...
 * HOLE3：预旋接受孔元件
 */
public class Hole3Base extends Component implements IVertexStencil {
    ...
    public Hole3Base(String name, String type, String argumentType, String stencilIcon, String graphIcon, IVertexRestriction restriction, boolean isPredefined, ArrayList<IVertexArgumentImpl> arguments, ArrayList<IVertexOutput> outputs) {
