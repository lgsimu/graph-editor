package com.lgsim.engine.graphEditor.data.components.library.tubep2.tubep2_base;
 ...
 * TUBEP2：油气两相流管元件
 */
public class Tubep2Base extends Component implements IVertexStencil {
    ...
    public Tubep2Base(String name, String type, String argumentType, String stencilIcon, String graphIcon, IVertexRestriction restriction, boolean isPredefined, ArrayList<IVertexArgumentImpl> arguments, ArrayList<IVertexOutput> outputs) {
