package com.lgsim.engine.graphEditor.data.components.library.vor.vor_base;
 ...
 * VOR: 旋转盘腔
 */
public class VorBase extends Component implements IVertexStencil {
    ...
    public VorBase(String name, String type, String argumentType, String stencilIcon, String graphIcon, IVertexRestriction restriction, boolean isPredefined, ArrayList<IVertexArgumentImpl> arguments, ArrayList<IVertexOutput> outputs) {
