package com.lgsim.engine.graphEditor.data.components.library.sealw.sealw_base;
...
/**
 * SEALW：轮缘封严，计算轮缘封严所需流量
 */
public class SealwBase extends Component implements IVertexStencil {
    ...
    public SealwBase(String name, String type, String argumentType, String stencilIcon, String graphIcon, IVertexRestriction restriction, boolean isPredefined, ArrayList<IVertexArgumentImpl> arguments, ArrayList<IVertexOutput> outputs) {
