package com.lgsim.engine.graphEditor.data.components.library.tube.tube_104;
 ...
 * 104类型元件
 */
public class Tube_104 extends TubeBase {

    private final String ID = "104";
    ...
    public List<IVertexArgument> getArguments() {
        ...
        IVertexArgumentImpl geo15 = new IVertexArgumentImpl("GEO15","1",0,0,0,"内弧长");
