package com.lgsim.engine.graphEditor.data.components.library.vor.vor_151;
 ...
 * 151类型元件
 */
public class Vor_151 extends VorBase {

    private final String ID = "151";
    ...
    public List<IVertexArgument> getArguments() {
        ...
        IVertexArgumentImpl geo6 = new IVertexArgumentImpl("GEO6","24",0,0,0,"输入温升");
