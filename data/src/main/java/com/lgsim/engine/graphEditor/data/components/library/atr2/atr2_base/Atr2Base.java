package com.lgsim.engine.graphEditor.data.components.library.atr2.atr2_base;
 ...
 * ATR2：绝对座标转相对座标
 */
public class Atr2Base extends Component implements IVertexStencil {
    ...
    public Atr2Base(String name, String type, String argumentType, String stencilIcon, String graphIcon, IVertexRestriction restriction, boolean isPredefined, ArrayList<IVertexArgumentImpl> arguments, ArrayList<IVertexOutput> outputs) {
