package com.lgsim.engine.graphEditor.data.components.library.seal.seal_base;
...
/**
 * SEAL：封严篦齿，包括NPU方法和Zimmerman方法
 */
public class SealBase extends Component implements IVertexStencil {
    ...
    public SealBase(String name, String type, String argumentType, String stencilIcon, String graphIcon, IVertexRestriction restriction, boolean isPredefined, ArrayList<IVertexArgumentImpl> arguments, ArrayList<IVertexOutput> outputs) {
