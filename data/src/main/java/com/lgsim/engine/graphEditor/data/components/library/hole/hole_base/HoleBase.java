package com.lgsim.engine.graphEditor.data.components.library.hole.hole_base;
 ...
 * HOLE:：一般孔元件，包括预旋喷嘴
 */
public class HoleBase extends Component implements IVertexStencil {
    ...
    public HoleBase(String name, String type, String argumentType, String stencilIcon, String graphIcon, IVertexRestriction restriction, boolean isPredefined, ArrayList<IVertexArgumentImpl> arguments, ArrayList<IVertexOutput> outputs) {
