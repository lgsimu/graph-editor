package com.lgsim.engine.graphEditor.data.components.library.tube.tube_base;
 ...
 * TUBE：管元件
 */
public class TubeBase extends Component implements IVertexStencil {
    ...
    public TubeBase(String name, String type, String argumentType, String stencilIcon, String graphIcon, IVertexRestriction restriction, boolean isPredefined, ArrayList<IVertexArgumentImpl> arguments, ArrayList<IVertexOutput> outputs) {
